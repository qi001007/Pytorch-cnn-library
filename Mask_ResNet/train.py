...
def train_val_data_process():
    # 定义数据集的路径
    ROOT_PATH_TRAIN = "./data/train"
    # 定义数据集处理方法变量
    normalize = transforms.Normalize(mean=[0.17263502, 0.15147281, 0.14267276],
    ...
    # 加载数据集
    data_ = ImageFolder(root=ROOT_PATH_TRAIN, transform=train_transforms)
    # 分割训练集和测试集
